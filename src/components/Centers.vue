...
<div class="column">
  <transition appear enter-active-class="animated backInDown">
    <h1 class="text-h4 q-mb-xs text-yellow-3 ">البلديــــــــات</h1>
  </transition>

  <transition appear enter-active-class="animated slideInRight">
    <div class="row q-mt-lg justify-between items-center full-width reverse  q-pa-sm q-pr-lg"
    style="border-radius: 10px; background-color: rgba(192, 244, 163, 0.3);"
    >
  ...
  <transition appear enter-active-class="animated slideInLeft">
    <q-list class="q-my-sm full-width" style="border-radius: 10px; margin-bottom: auto;">
