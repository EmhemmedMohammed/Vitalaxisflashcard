...
<div class="column">
  <div class="q-px-md q-pb-md" style=" position: fixed; top: 0; left: 0; right: 0; z-index: 200; background-color: rgb(2, 66, 109); padding-bottom: 10px;  max-width: 450px; margin: auto ; border-bottom: 2px solid rgb(142, 134, 156); box-shadow: 0px 5px 5px rgb(27, 23, 23); border-bottom-left-radius: 20px; border-bottom-right-radius: 20px;">
  ...
  <transition appear enter-active-class="animated slideInLeft">
    <q-list class="q-my-sm full-width" style="border-radius: 10px; margin-bottom: auto; margin-top: 140px;">
